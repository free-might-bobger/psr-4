...
<head>
  ...
  <title>Verify Your Email – My Near Shops</title>
</head>
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#1e1b4b 0%,#312e81 55%,#4c1d95 100%);padding:48px 40px 40px;text-align:center;">
              ...
              <h1 style="margin:0 0 8px;font-size:26px;font-weight:900;color:#ffffff;letter-spacing:-0.5px;line-height:1.2;">
                Welcome to My Near Shops!
              </h1>
              <p style="margin:0;font-size:15px;color:rgba(255,255,255,0.65);font-weight:500;">
                One last step — please verify your email address to get started
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="background:#ffffff;padding:40px;">
              ...
              <h2 style="margin:0 0 20px;font-size:22px;font-weight:900;color:#111827;line-height:1.3;">
                Thanks for signing up. Let's confirm your email address.
              </h2>
              <p style="margin:0 0 8px;font-size:15px;color:#6b7280;line-height:1.7;">
                To complete your registration, please verify that
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:16px 20px;">
                    <p style="margin:0 0 8px;font-size:13px;font-weight:800;color:#166534;">
                      🎉 What's next after verification?
                    </p>
                    <p style="margin:0;font-size:13px;color:#15803d;line-height:1.7;">
                      Once your email is verified, you can browse nearby shops, discover items, and place orders — all in one place.
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin:24px 0 0;font-size:13px;color:#9ca3af;text-align:center;line-height:1.6;">
                If you did not create an account with My Near Shops, you can safely ignore this email.
              </p>
