<template>
    <div style="margin: 5px">
      <section>
        <q-btn label="Checkpoint spotted" color="primary" @click="updateLocation" outline />
      </section>
      <GoogleMap class="q-mt-sm" :api-key="GOOGLE_MAP_API_KEY" :map-id="GOOGLE_MAP_ID" style="height: 450px"
